      ...
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link disabled" href="contact.php">Kontak</a>
            </li>
          </ul>
      ...
      <div class="album py-5 bg-light">
        <div class="container">
          ...
          <div class="row artikel">
                  ...
                  <div class="col-md-8">
                    <p><img src="images/logo.jpg" class="img img-thumbnail img-responsive"></p>
                   ...
                   <div class="col-md-4">
                    <aside>
                      ...
                      <ul>
                        <li><a href="detail.php">Berita Lainnya...</a></li>
                         <li><a href="detail.php">Berita Lainnya...</a></li>
                          <li><a href="detail.php">Berita Lainnya...</a></li>
                           <li><a href="detail.php">Berita Lainnya...</a></li>
                            <li><a href="detail.php">Berita Lainnya...</a></li>
